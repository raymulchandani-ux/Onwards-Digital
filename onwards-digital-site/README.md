...
Plain HTML, CSS and JavaScript. No build step. Push this folder to GitHub and
Vercel deploys it as-is.
...
assets/site.css       The design system (one file for all six pages)
assets/site.js        Shared behaviour: nav, currency, forms, add-on, submit
assets/config.js      ← THE ONLY FILE YOU NEED TO EDIT TO GO LIVE
examples/             Five demo homepages for fictional businesses
```

## 1. Go live checklist (edit `assets/config.js`)
...
`examples/restaurant.html` (Ossobello), `cafe.html` (Hollowmere), `salon.html`
(Tessaline), `trades.html` (Northgale), `shop.html` (Quillmont). Every business,
...
- Colours, spacing and type live at the top of `assets/site.css` (`:root`).
